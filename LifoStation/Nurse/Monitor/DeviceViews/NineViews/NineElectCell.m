...
#define kChartViewWidth 105
#define kChartViewHeight 72

#define kTimeLabelFont 11
#define kNoTimeLabelFont 11
...
- (void)configureWithModel:(MachineModel *)machine {
    ...
    if (machine.isonline) {
        ...
        self.statusLabel.text = [[MachineParameterTool sharedInstance]getStateShowingText:machine];
